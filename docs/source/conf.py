...
project = 'IP2Location.io Ruby SDK'
...
myst_html_meta = {
    "description": "IP2Location.io Ruby library allows user to query for an enriched data set based on IP address and provides WHOIS lookup API that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, Ruby, WHOIS, domain",
...
html_title = "IP2Location.io Ruby SDK"

# html_baseurl = "https://ip2location-io-ruby.readthedocs.io/en/latest/"